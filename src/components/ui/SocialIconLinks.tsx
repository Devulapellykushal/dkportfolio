      ...
      {socialLinks.map((link) => {
        ...
        return (
          <a
            ...
            className="inline-flex items-center gap-2 rounded-[2px] border border-white/15 bg-white/[0.05] px-3 py-2 text-sm text-[#f6f3f0]/85 transition hover:border-white/35 hover:text-white"
          >
